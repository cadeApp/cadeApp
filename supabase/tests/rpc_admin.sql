...
create or replace function pg_temp.merchant_id() returns uuid language sql immutable as $$
  select '00000000-0000-4000-8000-0000000000m1'::uuid
$$;
...
begin
  ...
  values
    ...
    (pg_temp.offer_accepted_id(), pg_temp.req_id(), pg_temp.courier_approved_id(), 1600, 25, 'accepted');
end;
$$;
