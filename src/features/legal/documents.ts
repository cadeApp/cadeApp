  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Conforme al artículo 6 de la Ley 25.326, se informa expresamente el carácter obligatorio o facultativo de proporcionar los datos solicitados:',
          'Son datos obligatorios para el uso de la plataforma: datos de cuenta (correo, contraseña gestionada externamente y rol); para comercios, nombre del negocio, dirección/zona de retiro y teléfono; para repartidores, nombre, DNI, imágenes de DNI, selfie y datos del vehículo y patente; para solicitudes de envío, los datos mínimos del destinatario (nombre, teléfono y punto o dirección de entrega) indispensables para la coordinación del traslado.',
          'Son datos facultativos: notas adicionales de entrega, referencias accesorias, la carga de licencia de conducir y póliza de seguro en el perfil del repartidor (sin perjuicio de las exigencias normativas vigentes para circular en la vía pública), y la habilitación de notificaciones push.',
          'Consecuencias de la negativa o inexactitud: la negativa a suministrar los datos obligatorios o la indicación de datos inexactos impide la creación o activación de la cuenta, la validación del perfil, la publicación de solicitudes, la formulación de ofertas o la asignación y concreción de entregas. La inexactitud o falsedad comprobada de la información suministrada facultará la suspensión cautelar de la cuenta. La no provisión de datos facultativos no impide la utilización básica de la plataforma, aunque puede limitar ciertas funciones accesorias o requerir coordinación manual.',
        ],
      },
      {
        id: 'finalidades',
