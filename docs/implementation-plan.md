...
| T-311 | P1 | Páginas legales P04 y consentimientos versionados, con contenido contrastado con normativa argentina vigente y fuentes oficiales | T-111, T-118, T-121 | Alcance puntual definido en `docs/tasks/T-311.md` | Pruebas en rojo antes de implementar y commit separado: rutas legales inexistentes, versión no registrada y consentimiento aceptado con una versión que no coincide. |
