...
| T-311 | P1 | Páginas legales P04 y consentimientos versionados, con contenido contrastado con normativa argentina vigente y fuentes oficiales | T-111, T-118, T-121 | Alcance puntual definido en `docs/tasks/T-311.md` | Los textos legales describen el funcionamiento real de cadeApp y se contrastan con normativa argentina vigente y fuentes oficiales; el PR documenta las fuentes consultadas y no afirma revisión externa inexistente. |
