...
No aparece un patrón técnico nuevo. La ronda confirma dos controles de proceso ya documentados:

- **AG-109:** evidencia visual válida significa ruta real/app corriendo, no un HTML que se le parezca.
- **AG-110:** el verde solo vale contra el SHA de base que realmente se va a mergear.

La Ronda 6 también corrigió el canal de entrega de la revisión: al ser una PR de P2, el registro independiente vive en la rama `docs/revisiones` y no vuelve a mover el head del autor.
