...
select pg_temp.try($$select public.admin_set_subscription('aaaaaaaa-0000-4000-8000-000000000002','active','2026-12-31',null)::text$$,'aaaaaaaa-0000-4000-8000-000000000001','aal2');
\echo '--- filas de audit_log por accion'
select action, count(*), max(after::text) from public.audit_log group by action order by 1;
rollback;
